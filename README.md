...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/texttomyimage
```

A live public deployment of this template is available at [https://texttomyimage.templates.workers.dev](https://texttomyimage.templates.workers.dev)
